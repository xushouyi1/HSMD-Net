...
tag = 'else'
if args.type == 0:
    args.train_dir = '/data/xsy/CODE/datasets_train/thick_660/train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "/data/xsy/CODE/datasets_test/Haze1k/Haze1k_thin/dataset/test/"
    args.test_name = 'input,target'
    tag = 'thin'
elif args.type == 1:
    args.train_dir = '/data/xsy/CODE/datasets_train/thick_660/train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "/data/xsy/CODE/datasets_test/Haze1k/Haze1k_moderate/dataset/test/"
    args.test_name = 'input,target'
    tag = 'moderate'
elif args.type == 2:
    args.train_dir = '/data/xsy/CODE/datasets_train/thick_660/train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "/data/xsy/CODE/datasets_test/Haze1k/Haze1k_thick/dataset/test/"
    args.test_name = 'input,target'
    tag = 'thick'
elif args.type == 3:
    args.train_dir = '/data/xsy/CODE/datasets_train/DHID/train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "/data/xsy/CODE/datasets_test/DHID/"
    ...
    args.train_dir = '/data/xsy/xsy-rice1/train/'
    args.train_name = 'hazy,clear'
    args.test_dir = "/data/xsy/LHID/"
    args.test_name = 'hazy,clean'
    tag = 'LHID'
elif args.type == 10:
    ...
    args.train_dir = '/data/xsy/data/RSID/train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "/data/xsy/data/RSID/test/"
    args.test_name = 'hazy,clean'
    tag = 'RSID'
elif args.type == 13:
    args.train_dir = '/data/xsy/data/NID/Thin/NID_thin_train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "/data/xsy/data/NID/Thin/NID_thin_test/"
    args.test_name = 'hazy,clean'
    tag = 'NID_thin'
elif args.type == 14:
    args.train_dir = '/data/xsy/data/NID/Dense/NID_dense_train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "/data/xsy/data/NID/Dense/NID_dense_test/"
    args.test_name = 'hazy,clean'
    tag = 'NID_dense'
