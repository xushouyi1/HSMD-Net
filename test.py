...
if args.type == 0:
    ...
    args.train_dir = '../RICE1_1/train/'
    args.train_name = 'hazy,clean'
    args.test_dir = "../RICE1_1/test/"
    args.test_name = 'hazy,clean'
    tag = 'RICE1_1'
elif args.type == 9:
    args.train_dir = '/data/xsy/CODE/datasets_train/LHID/train/'
    args.train_name = 'input,target'
    args.test_dir = "/data/xsy/CODE/datasets_test/LHID/"
    args.test_name = 'input,target'
    tag = 'LHID'
elif args.type == 10:
